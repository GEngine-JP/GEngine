...
import info.xiaomo.gameCore.base.common.CSVUtil;
import info.xiaomo.gameCore.base.common.Cast;
import info.xiaomo.gameCore.base.common.ReflectUtil;
...
public class ConfigDataContainer<T extends IConfigData> {
    ...
    private T converterObject(Map<String, String> data) throws InstantiationException, IllegalAccessException,
        ...
        for (String key : data.keySet()) {
            ...
            ReflectUtil.PropertyDesc desc = ReflectUtil.getPropertyDesc(clazz, key);
            if (desc == null) {
    ...
    private Map<Object, T> buildCache(List<T> list, String key) throws IllegalAccessException,
        ...
        ReflectUtil.PropertyDesc propertyDesc[] = new ReflectUtil.PropertyDesc[keys.length];

        for (int i = 0; i < keys.length; i++) {
            String keyField = keys[i];
            // 获取该key对应的方法
            ReflectUtil.PropertyDesc desc = ReflectUtil.getPropertyDesc(clazz, keyField);
    ...
    public Object buildKey(T value, ReflectUtil.PropertyDesc propertyDesc[]) throws IllegalAccessException, IllegalArgumentException,
        ...
        for (ReflectUtil.PropertyDesc desc : propertyDesc) {
     ...
     * @return Object
     */
    private Object covertValue(ReflectUtil.PropertyDesc desc, String oldValue) {
