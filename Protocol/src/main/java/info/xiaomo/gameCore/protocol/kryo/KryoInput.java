 ...
 * byte array from another OutputStream as needed. Utility methods are provided
...
public class KryoInput extends InputStream {
	 ...
	 * strings written by {@link KryoOutput#writeString(String)} ,
	 * {@link KryoOutput#writeString(CharSequence)}, and
	 * {@link KryoOutput#writeAscii(String)}.
	 * 
	 * @return May be null.
	 */
	...
	private void readUtf8_slow(int charCount, int charIndex) {
		...
		while (charIndex < charCount) {
			...
			case 14:
				require(2);
				chars[charIndex] = (char) ((b & 0x0F) << 12 | (buffer[position++] & 0x3F) << 6
