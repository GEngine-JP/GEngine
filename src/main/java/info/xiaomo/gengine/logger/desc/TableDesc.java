package info.xiaomo.gengine.logger.desc;
...
public class TableDesc {
	...
	private final SimpleDateFormat yyyyMmDd = new SimpleDateFormat("_yyyy_MM_dd");
	private final SimpleDateFormat yyyyMm = new SimpleDateFormat("_yyyy_MM");
	private final SimpleDateFormat yyyy = new SimpleDateFormat("_yyyy");
