...
public class MessageDispatcher implements Telegraph {
	...
	public void addProvider(TelegramProvider provider, int msg) {
		List<TelegramProvider> providers = msgProviders.computeIfAbsent(msg, k -> new ArrayList<TelegramProvider>(16));
	 ...
	 * dispatchMessage(0, null, null, telegram, null, false)}
	 *
	 * @param msg the message code
	 */
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(0, sender, null, telegram, null, false)}
	 *
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(0, sender, null, telegram, null, needsReturnReceipt)}
	 *
	 * @param sender             the sender of the telegram
	 * @param msg                the message code
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(0, null, null, telegram, extraInfo, false)}
	 *
	 * @param msg       the message code
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(0, sender, null, telegram, extraInfo, false)}
	 *
	 * @param sender    the sender of the telegram
	 * @param msg       the message code
	 * @param extraInfo an optional object
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(0, sender, null, telegram, extraInfo, needsReturnReceipt)}
	 *
	 * @param sender             the sender of the telegram
	 * @param msg                the message code
	 * @param extraInfo          an optional object
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(0, sender, receiver, telegram, null, false)}
	 *
	 * @param sender   the sender of the telegram
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(0, sender, receiver, telegram, null, needsReturnReceipt)}
	 *
	 * @param sender             the sender of the telegram
	 * @param receiver           the receiver of the telegram; if it's {@code null} the telegram is
	 *                           broadcasted to all the receivers registered for the specified
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(0, sender, receiver, telegram, extraInfo, false)}
	 *
	 * @param sender    the sender of the telegram
	 * @param receiver  the receiver of the telegram; if it's {@code null} the telegram is
	 *                  broadcasted to all the receivers registered for the specified
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(0, sender, receiver, telegram, extraInfo, needsReturnReceipt)}
	 *
	 * @param sender             the sender of the telegram
	 * @param receiver           the receiver of the telegram; if it's {@code null} the telegram is
	 *                           broadcasted to all the receivers registered for the specified
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(delay, null, null, telegram, null, null)}
	 *
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(delay, sender, null, telegram, null, false)}
	 *
	 * @param delay  the delay in seconds
	 * @param sender the sender of the telegram
	 * @param msg    the message code
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(delay, sender, null, telegram, null, needsReturnReceipt)}
	 *
	 * @param delay              the delay in seconds
	 * @param sender             the sender of the telegram
	 * @param msg                the message code
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(delay, null, null, telegram, extraInfo, false)}
	 *
	 * @param delay     the delay in seconds
	 * @param msg       the message code
	 * @param extraInfo an optional object
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(delay, sender, null, telegram, extraInfo, false)}
	 *
	 * @param delay     the delay in seconds
	 * @param sender    the sender of the telegram
	 * @param msg       the message code
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(delay, sender, null, telegram, extraInfo, needsReturnReceipt)}
	 *
	 * @param delay              the delay in seconds
	 * @param sender             the sender of the telegram
	 * @param msg                the message code
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(delay, sender, receiver, telegram, null, false)}
	 *
	 * @param delay    the delay in seconds
	 * @param sender   the sender of the telegram
	 * @param receiver the receiver of the telegram; if it's {@code null} the telegram is
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(delay, sender, receiver, telegram, null, needsReturnReceipt)}
	 *
	 * @param delay              the delay in seconds
	 * @param sender             the sender of the telegram
	 * @param receiver           the receiver of the telegram; if it's {@code null} the telegram is
	 ...
	 * <p>
	 * This is a shortcut method for
	 * dispatchMessage(delay, sender, receiver, telegram, extraInfo, false)}
	 *
	 * @param delay     the delay in seconds
	 * @param sender    the sender of the telegram
	 * @param receiver  the receiver of the telegram; if it's {@code null} the telegram is
