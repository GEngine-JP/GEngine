...
/**
 * 图接口 <br>
 * A graph is a collection of nodes, each one having a collection of outgoing {@link Connection
 * connections}.
 *
...
public interface Graph<N> {
    ...
    /**
     * 和当前节点相连的连接关系 Returns the connections outgoing from the given node.
     *
