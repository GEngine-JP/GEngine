...
import info.xiaomo.gengine.script.zl.annotation.Exclude;
import info.xiaomo.gengine.script.zl.annotation.Script;
...
public class ScriptEngine {
	...
	private static boolean checkAndLoad(Collection<Class<?>> classList, boolean annotation) {
		...
		Map<IScript, Integer> orderMap = new HashMap<>(10);
