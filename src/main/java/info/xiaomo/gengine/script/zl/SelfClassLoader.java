...
public class SelfClassLoader extends ClassLoader {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		SelfClassLoader scriptClassLoader = new SelfClassLoader("/Users/ctwdevops/Workspace/game/GEngine/target/classes");
		Class<?> c = scriptClassLoader.loadClass("info.xiaomo.gengine.script.zl.IScript");
