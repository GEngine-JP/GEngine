...
public class ClassUtil {
     ...
     * @return
     */
    public static Set<Class<?>> findClassWithAnnotation(
        ...
        try {
            ...
            while (dirs.hasMoreElements()) {
                ...
                if (PROTOCOL_FILE.equals(protocol)) {
                    ...
                    allClazz.addAll(
                            findClassFromDir(classLoader, packageName, filePath, recursive));
     ...
     * @return
     */
    private static Set<Class<?>> findClassFromJar(
            ClassLoader classLoader, JarFile jar, String packageDir) {
     ...
     * @return
     */
    private static Set<Class<?>> findClassFromDir(
            ClassLoader classLoader, String packageName, String filePath, boolean recursive) {
