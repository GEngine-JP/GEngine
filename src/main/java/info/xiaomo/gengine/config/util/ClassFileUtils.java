...
public class ClassFileUtils {
	 ...
	 * @return
	 */
	public static Set<Class<IConfig>> getClasses(String packageName, Predicate<Class<IConfig>> predicate) {
	 ...
	 * @return
	 */
	public static Set<Class<IConfig>> getClasses(String packageName, boolean recursive, Predicate<Class<IConfig>> predicate) {
		Set<Class<IConfig>> ret = new LinkedHashSet<>();
	...
	private static Set<Class<IConfig>> findSubClassFromJar(JarFile jar, String packageName, boolean recursive, Predicate<Class<IConfig>> predicate) {
		Set<Class<IConfig>> ret = new LinkedHashSet<>();
		...
		while (entries.hasMoreElements()) {
			...
			try {
				...
				Class<IConfig> clazz = (Class<IConfig>) Class.forName(className, false, ClassFileUtils.class.getClassLoader());
	...
	private static Set<Class<IConfig>> findSubClassFromFile(String packageName, String packagePath, boolean recursive, Predicate<Class<IConfig>> predicate) {
		Set<Class<IConfig>> ret = new LinkedHashSet<>();
