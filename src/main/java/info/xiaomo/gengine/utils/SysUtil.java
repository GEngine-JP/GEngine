...
public final class SysUtil {
    ...
    public static String compilationInfo(String splitStr) {
        ...
        sb.append("是否支持编译监视:   ")
                .append(bean.isCompilationTimeMonitoringSupported())
                .append(splitStr);
        return sb.toString();
    }
    ...
    public static String jvmInfo(String spliteStr) {
        ...
        sb.append("Java供应商的URL：    ")
                .append(props.getProperty("java.vendor.url"))
                .append(spliteStr);
        ...
        sb.append("Java的虚拟机规范名称：    ")
                ...
                .append(spliteStr);
        sb.append("Java的虚拟机实现版本：    ")
                .append(props.getProperty("java.vm.version"))
                .append(spliteStr);
        sb.append("Java的虚拟机实现供应商：    ")
                .append(props.getProperty("java.vm.vendor"))
                .append(spliteStr);
        sb.append("Java的虚拟机实现名称：    ").append(props.getProperty("java.vm.name")).append(spliteStr);
        sb.append("Java运行时环境规范版本：    ")
                .append(props.getProperty("java.specification.version"))
                .append(spliteStr);
        sb.append("Java运行时环境规范供应商：    ")
                .append(props.getProperty("java.specification.vender"))
                .append(spliteStr);
        sb.append("Java运行时环境规范名称：    ")
                .append(props.getProperty("java.specification.name"))
                .append(spliteStr);
        sb.append("Java的类格式版本号：    ")
                .append(props.getProperty("java.class.version"))
                .append(spliteStr);
        sb.append("加载库时搜索的路径列表：    ")
                .append(props.getProperty("java.library.path"))
                .append(spliteStr);
