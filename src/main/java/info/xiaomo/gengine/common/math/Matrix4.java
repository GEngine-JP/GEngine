package info.xiaomo.gengine.common.math;
...
public class Matrix4 implements Serializable {
     ...
     * Sets the matrix to a rotation matrix representing the quaternion.
     *
     * @param quaternionX The X component of the quaternion that is to be used to set this
     *                    matrix.
     * @param quaternionY The Y component of the quaternion that is to be used to set this
     *                    matrix.
     * @param quaternionZ The Z component of the quaternion that is to be used to set this
     *                    matrix.
     * @param quaternionW The W component of the quaternion that is to be used to set this
     *                    matrix.
     * @return This matrix for the purpose of chaining methods together.
     */
     ...
     * quaternion.
     *
     * @param translationX The X component of the translation that is to be used to set this
     *                     matrix.
     * @param translationY The Y component of the translation that is to be used to set this
     *                     matrix.
     * @param translationZ The Z component of the translation that is to be used to set this
     *                     matrix.
     * @param quaternionX  The X component of the quaternion that is to be used to set this
     *                     matrix.
     * @param quaternionY  The Y component of the quaternion that is to be used to set this
     ...
     *
     * @param vector The translation vector to add to the current matrix. (This vector
     *               is not modified)
     * @return This matrix for the purpose of chaining methods together.
     */
     ...
     * @param normalizeAxes True to normalize the axes, necessary when the matrix might also
     *                      include scaling.
    ...
    /**
     * @param scale The vector which will receive the (non-negative) scale components
     *              on each axis.
