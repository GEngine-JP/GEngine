...
/**
 * 几何计算工具<br>
 * Class containing some geometry algorithms. Note that the implementation of some algorithms is not
 * thread-safe.
 *
 * @author jsjolund
 * @author davebaol
...
public final class GeometryUtil {
    ...
    /**
     * 获取离三角形最近的点 Find the closest point on the triangle, given a measure point. This is the
     * optimized algorithm taken from the book "Real-Time Collision Detection".
     *
     ...
     */
    public static float getClosestPointOnTriangle(
            Vector3 a, Vector3 b, Vector3 c, Vector3 p, Vector3 out) {
