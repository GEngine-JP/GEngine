...
public class Dispatcher {
    ...
    public static void load(String packageName) {
        ...
        Set<Class<?>> controllerClasses =
                ClassUtil.findClassWithAnnotation(packageName, Controller.class);
        ...
        for (Class<?> clazz : controllerClasses) {
            ...
            for (Method method : methods) {
                ...
                LOGGER.error(
                        "发现controller," + path + "->" + clazz.getName() + "." + method.getName());
            }
        }
    }
