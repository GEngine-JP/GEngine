...
public class Bits {
    ...
    /**
     * Returns the "logical size" of this bitset: the index of the highest set bit in the bitset
     * plus one. Returns zero if the bitset contains no set bits.
     *
     ...
     * is modified so that each bit in it has the value true if and only if it both initially had
    ...
    /**
     * Clears all of the bits in this bit set whose corresponding bit is set in the specified bit
     * set.
     *
     * @param other a bit set
     */
     ...
     * modified so that a bit in it has the value true if and only if it either already had the
     ...
     * modified so that a bit in it has the value true if and only if one of the following
     * statements holds:
     *
     * <ul>
     *   <li>The bit initially has the value true, and the corresponding bit in the argument has the
     *       value false.
     *   <li>The bit initially has the value false, and the corresponding bit in the argument has
     *       the value true.
     * </ul>
     *
     * @param other
    ...
    /**
     * Returns true if the specified BitSet has any bits set to true that are also set to true in
     * this BitSet.
     *
     * @param other a bit set
