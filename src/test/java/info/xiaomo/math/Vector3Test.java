...
public class Vector3Test {
    ...
    public void testIsOnSegment() {
        assertTrue(
                Vector3.isPointOnSegment(
                        new Vector3(0, 0), new Vector3(10, 10), new Vector3(5, 5)));
        assertFalse(
                Vector3.isPointOnSegment(
                        new Vector3(0, 0), new Vector3(10, 10), new Vector3(15, 15)));
        assertFalse(
                Vector3.isPointOnSegment(
                        new Vector3(0, 0), new Vector3(10, 10), new Vector3(-5, -5)));
        assertFalse(
                Vector3.isPointOnSegment(
                        new Vector3(0, 0), new Vector3(10, 10), new Vector3(5, 3)));
    }
}
