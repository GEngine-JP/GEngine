...
public class Vector3Test {
  ...
  public void testIsCloseTo() {
    ...
    assertTrue(vector3.isCloseTo(vector32, 2));
    assertTrue(vector3.isCloseTo(vector32, 2.5f));
    assertFalse(vector3.isCloseTo(vector32, 1.99f));
  }
  ...
  public void testIsOnSegment() {
    ...
    assertFalse(
        Vector3.isPointOnSegment(new Vector3(0, 0), new Vector3(10, 10), new Vector3(15, 15)));
    assertFalse(
        Vector3.isPointOnSegment(new Vector3(0, 0), new Vector3(10, 10), new Vector3(-5, -5)));
    assertFalse(
        Vector3.isPointOnSegment(new Vector3(0, 0), new Vector3(10, 10), new Vector3(5, 3)));
  }
}
